...
const Blog = ({ props }) => {
  //   const { category, title, author, date, image } = props;
  return (
    <div className="blog-post">
      <main className="my-10">
        ...
        >
          <div
            className="absolute left-0 bottom-0 bg-cover w-full h-full z-10 rounded-lg"
            style={{
              backgroundImage:
        ...
        <div className="px-4 lg:px-0 mt-12 text-white max-w-screen-md mx-auto text-lg leading-relaxed text-center">
          <p className="pb-6">
          ...
          <div className="border-l-4 border-black-500 pl-4 mb-6 italic rounded">
          ...
          <h2 className="text-3xl text-black font-semibold mb-10 mt-4 underline">
            Uneasy barton seeing remark happen his has
          </h2>

          <p className="pb-6">
            Make my no cold of need. He been past in by my hard. Warmly thrown
            oh he common future. Otherwise concealed favourite frankness on be
            at dashwoods defective at. Sympathize interested simplicity at do
