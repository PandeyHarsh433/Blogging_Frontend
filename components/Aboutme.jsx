...
const Aboutme = () => {
  return (
    <>
      <div className="flex flex-col justify-center max-w-xs pb-2 lg:pt-20 rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100 profile">
        <img
          src="/profile.jpg"
          alt=""
          className="w-60 h-58 mx-auto rounded-full dark:bg-gray-500 aspect-square"
        />
        <div className="space-y-4 text-center divide-y divide-gray-700 text-white">
          <div className="my-2 space-y-1">
            <h2 className="text-2xl font-semibold sm:text-3xl">Harsh Pandey</h2>
          ...
          <div className="flex justify-center pt-2 space-x-4 align-center">
            ...
            >
              <svg
                ...
                className="w-4 h-4 fill-current w-8 h-8"
              >
            ...
            <a
              rel="noopener noreferrer"
              href="mailto:pandeyharsh704@gmail.com"
              target="_blank"
              aria-label="Email"
              className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400"
            >
      ...
      <div className="bg-transparent bg-opacity-80 mb-10 mt-5 py-10 w-full px-4 flex flex-col items-center justify-center relative z-40 newsletter">
